...
export default function NewsHeroText({ count }: { count: number }) {
  ...
  return (
    <div ref={ref} className="flex-1 flex flex-col justify-end pb-12 md:pb-16">
      <div className="flex flex-col gap-6">
        ...
        <div className="nh-line flex items-center justify-between">
        ...
        <div className="nh-line h-px w-full bg-white/20" />

        <h1 className="nh-line font-[family-name:var(--font-inter)] font-medium capitalize tracking-[-0.07em] text-white leading-[0.85] text-[80px] md:text-[13.75vw]">
          News &amp;<br />Achievements.
        </h1>

        <div className="nh-line flex items-end justify-between">
